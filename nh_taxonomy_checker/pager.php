...
error_reporting(E_ALL);
    ...
    class HTMLPager
    {
        ...
        public function __construct($p_data_bag, $p_page_size, $p_page_path, $p_headers, $p_sources)
        {
        ...
        public function get_page($p_page)
        {
            ...
            if(array_key_exists("results", $_SESSION[session_id()]))
            {
                ...
                {
                    ParseFishbaseJSON::pad_results($result_bag);
                    $_SESSION[session_id()]["results"]=$result_bag;                
                }
